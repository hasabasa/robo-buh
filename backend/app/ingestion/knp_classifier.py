...
INCOME_KNP: set[str] = {"190", "710", "821"}   # 190 — прочие расчёты за товары (в т.ч. «Продажи с Kaspi.kz»),
                                               # 710 — за товары, 821 — строительные услуги
...
NONINCOME_KNP: set[str] = {
    ...
    "390",                     # прочие переводы денег (в т.ч. со своего KaspiPay/депозита) — не выручка

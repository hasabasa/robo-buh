...
C14N_INCLUSIVE = "http://www.w3.org/TR/2001/REC-xml-c14n-20010315"  # как в примерах SDK
...
def get_esf_version(base: str = TEST_BASE, **kw) -> str | None:
    ...
    root = _post(base, "VersionService", "<esf:getEsfVersionRequest/>",
                 action="esf/VersionService/getEsfVersion", **kw)
...
def sign_auth_ticket(ticket_xml: str, p12_path: str, p12_pin: str) -> str:
    ...
    # самопроверка: подпись валидна против собственного серта
